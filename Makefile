...
CXX= g++
CPPFLAGS= -g --std=c++11 -Wall -O2 -fPIC -DDAG_SYNCHRONIZE_USE -DDAG_THREAD_USE
CFLAGS := $(CPPFLAGS)
BUILD = build
BIN =
...
$(DAG): $(call FIND_CPP, dag common/conf common dag_test,o) $(call FIND, proto,o)  build/$(DAG).o
	$(CXX) $(filter %.o, $^) $(CFLAGS) $(INCLUDE) -o $@ $(LIBS)
