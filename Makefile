...
BRPC_INC=-I$(THIRD_PARTY)/brpc/include -I$(THIRD_PARTY)/glog/include -I$(THIRD_PARTY)/gtest/include \
	 -I$(THIRD_PARTY)/protobuf/include -I$(THIRD_PARTY)/xml/include $(BOOST_INC)
BRPC_LIB=-L$(THIRD_PARTY)/glog/lib64/ -lglog \
	 -L$(THIRD_PARTY)/gtest/lib64/ -lgtest -L$(THIRD_PARTY)/protobuf/lib64/ -lprotobuf -lprotoc \
	 -L$(THIRD_PARTY)/xml/lib64/ -ltinyxml $(BOOST_LIB) -L$(THIRD_PARTY)/brpc/lib64/ -lbrpc \
