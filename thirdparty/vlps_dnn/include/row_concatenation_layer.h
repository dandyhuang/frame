#ifndef BAIDU_FCR_MODEL_ABACUS_DNN_ROW_CONCATENATION_LAYER_H
#define BAIDU_FCR_MODEL_ABACUS_DNN_ROW_CONCATENATION_LAYER_H
...
#endif //BAIDU_FCR_MODEL_ABACUS_DNN_ROW_CONCATENATION_LAYER_H
