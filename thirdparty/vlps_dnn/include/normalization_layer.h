#ifndef BAIDU_FCR_MODEL_ABACUS_DNN_NORMALIZATION_LAYER_H
#define BAIDU_FCR_MODEL_ABACUS_DNN_NORMALIZATION_LAYER_H
...
private:
    ...
    Eigen::RowVectorXf _means, _scales;
    double _squared_sum_epsilon = 1e-4;
};

}
#endif //BAIDU_FCR_MODEL_ABACUS_DNN_NORMALIZATION_LAYER_H
