...
int main(int argc, char** argv) {
  ...
  jieba.Cut(s, words, true, true);
  cout << limonp::Join(words.begin(), words.end(), "/") << endl;
  jieba.Cut(s, words, true, false);
  cout << limonp::Join(words.begin(), words.end(), "/") << endl;

  cout << "[demo] Cut Without HMM " << endl;
  jieba.Cut(s, words, false, true);
  cout << limonp::Join(words.begin(), words.end(), "/") << endl;

  s = "我来到北京清华大学";
  cout << s << endl;
  cout << "[demo] CutAll" << endl;
  jieba.CutAll(s, words, true);
  cout << limonp::Join(words.begin(), words.end(), "/") << endl;

  s = "小明硕士毕业于中国科学院-计算所，后在日本京都大学深造";
  cout << s << endl;
  cout << "[demo] CutForSearch" << endl;
  jieba.CutForSearch(s, words, true, true);
  cout << limonp::Join(words.begin(), words.end(), "/") << endl;

  cout << "[demo] Insert User Word" << endl;
  jieba.Cut("男默女泪", words, true, true);
  cout << limonp::Join(words.begin(), words.end(), "/") << endl;
  ...
  jieba.CutForSearch(s, jiebawords, true, true);
