...
void AddDescriptors_brpc_2fget_5ffavicon_2eproto();
namespace brpc {
...
class GetFaviconRequest :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.GetFaviconRequest) */ {
 public:
  GetFaviconRequest();
...
class GetFaviconResponse :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.GetFaviconResponse) */ {
 public:
  GetFaviconResponse();
