...
void AddDescriptors_brpc_2fget_5fjs_2eproto();
namespace brpc {
class GetJsRequest;
...
class GetJsRequest :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.GetJsRequest) */ {
 public:
  GetJsRequest();
...
class GetJsResponse :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.GetJsResponse) */ {
 public:
  GetJsResponse();
