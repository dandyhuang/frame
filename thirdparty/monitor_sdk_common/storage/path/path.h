...
#ifndef COMMON_STORAGE_PATH_PATH_H
#define COMMON_STORAGE_PATH_PATH_H

#include <string>
#include "thirdparty/monitor_sdk_common/base/static_class.h"

namespace common {

// Path operation of file system.
class Path {
    COMMON_DECLARE_STATIC_CLASS(Path);
...
#endif // COMMON_STORAGE_PATH_PATH_H
