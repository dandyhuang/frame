...
#ifndef COMMON_STORAGE_SSTABLE_WRITER_SINGLE_SSTABLE_WRITER_H
#define COMMON_STORAGE_SSTABLE_WRITER_SINGLE_SSTABLE_WRITER_H
...
class SingleSSTableWriter : public SSTableWriter {
    COMMON_DECLARE_UNCOPYABLE(SingleSSTableWriter);
...
#endif  // COMMON_STORAGE_SSTABLE_WRITER_SINGLE_SSTABLE_WRITER_H
