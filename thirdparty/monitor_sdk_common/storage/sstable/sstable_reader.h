...
#ifndef COMMON_STORAGE_SSTABLE_SSTABLE_READER_H
#define COMMON_STORAGE_SSTABLE_SSTABLE_READER_H
...
class SSTableReader {
    COMMON_DECLARE_UNCOPYABLE(SSTableReader);
...
protected:
    ...
    common::scoped_ptr<SSTableReader::Impl> impl_;
};

class SSTableReader::Iterator {
    COMMON_DECLARE_UNCOPYABLE(Iterator);
...
#endif  // COMMON_STORAGE_SSTABLE_SSTABLE_READER_H
