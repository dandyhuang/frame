...
#ifndef COMMON_STORAGE_SSTABLE_HFILE_DATA_INDEX_H
#define COMMON_STORAGE_SSTABLE_HFILE_DATA_INDEX_H
...
class DataIndex : public Block {
    COMMON_DECLARE_UNCOPYABLE(DataIndex);
...
#endif  // COMMON_STORAGE_SSTABLE_HFILE_DATA_INDEX_H
