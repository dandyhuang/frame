...
#ifndef COMMON_STORAGE_SSTABLE_HFILE_DATA_BLOCK_H
#define COMMON_STORAGE_SSTABLE_HFILE_DATA_BLOCK_H
...
class DataBlock : public Block {
    COMMON_DECLARE_UNCOPYABLE(DataBlock);
...
#endif  // COMMON_STORAGE_SSTABLE_HFILE_DATA_BLOCK_H
