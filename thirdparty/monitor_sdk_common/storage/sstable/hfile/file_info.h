...
#ifndef COMMON_STORAGE_SSTABLE_HFILE_FILE_INFO_H
#define COMMON_STORAGE_SSTABLE_HFILE_FILE_INFO_H
...
class FileInfo : public Block {
    COMMON_DECLARE_UNCOPYABLE(FileInfo);
...
#endif  // COMMON_STORAGE_SSTABLE_HFILE_FILE_INFO_H
