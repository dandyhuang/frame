...
#ifndef COMMON_STORAGE_SSTABLE_HFILE_FILE_TRAILER_H
#define COMMON_STORAGE_SSTABLE_HFILE_FILE_TRAILER_H
...
class FileTrailer : public Block {
    COMMON_DECLARE_UNCOPYABLE(FileTrailer);
...
#endif  // COMMON_STORAGE_SSTABLE_HFILE_FILE_TRAILER_H
