...
#ifndef COMMON_SYSTEM_PROCESS_SUB_PROCESS_H
#define COMMON_SYSTEM_PROCESS_SUB_PROCESS_H
...
class SubProcess
{
    COMMON_DECLARE_UNCOPYABLE(SubProcess);
...
#endif // COMMON_SYSTEM_PROCESS_SUB_PROCESS_H
