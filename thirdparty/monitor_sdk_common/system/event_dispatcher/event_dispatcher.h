...
#ifndef COMMON_SYSTEM_EVENT_DISPATCHER_EVENT_DISPATCHER_H
#define COMMON_SYSTEM_EVENT_DISPATCHER_EVENT_DISPATCHER_H
#pragma once
...
class EventDispatcher {
    COMMON_DECLARE_UNCOPYABLE(EventDispatcher);
...
class EventWatcherBase : private CWatcherType {
    COMMON_DECLARE_UNCOPYABLE(EventWatcherBase);
...
#endif // COMMON_SYSTEM_EVENT_DISPATCHER_EVENT_DISPATCHER_H
