...
MutexBase::MutexBase(int type)
{
    ...
    COMMON_CHECK_PTHREAD_ERROR(pthread_mutexattr_init(&attr));
    COMMON_CHECK_PTHREAD_ERROR(pthread_mutexattr_settype(&attr, type));
    COMMON_CHECK_PTHREAD_ERROR(pthread_mutex_init(&m_mutex, &attr));
    COMMON_CHECK_PTHREAD_ERROR(pthread_mutexattr_destroy(&attr));
}

MutexBase::~MutexBase()
{
    COMMON_CHECK_PTHREAD_ERROR(pthread_mutex_destroy(&m_mutex));
