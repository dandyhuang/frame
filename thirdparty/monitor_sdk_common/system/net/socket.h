...
#ifndef COMMON_SYSTEM_NET_SOCKET_H
#define COMMON_SYSTEM_NET_SOCKET_H
...
#include "thirdparty/monitor_sdk_common/system/net/socket.inl"

#endif // COMMON_SYSTEM_NET_SOCKET_H
