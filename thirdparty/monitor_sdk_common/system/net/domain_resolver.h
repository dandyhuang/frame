...
#ifndef COMMON_SYSTEM_NET_DOMAIN_RESOLVER_H
#define COMMON_SYSTEM_NET_DOMAIN_RESOLVER_H
#pragma once
...
template <>
inline void swap(common::HostEntry& h1, common::HostEntry& h2)
{
    h1.Swap(&h2);
}
...
#endif // COMMON_SYSTEM_NET_DOMAIN_RESOLVER_H
