...
#ifndef COMMON_SYSTEM_NET_IP_ADDRESS_H
#define COMMON_SYSTEM_NET_IP_ADDRESS_H
#pragma once
...
#include "thirdparty/monitor_sdk_common/system/net/os_socket.h"
...
public:
    ...
    DEPRECATED void ToString(::std::string& str) const // NOLINT(runtime/references)
    {
        ToString(&str);
    }
...
inline const std::string IpAddress::ToHexString() const
{
    std::string result;
    ToHexString(&result);
    return result;
...
#endif // COMMON_SYSTEM_NET_IP_ADDRESS_H
