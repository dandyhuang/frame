...
#ifndef COMMON_COLLECTION_PREFIX_MAP_H
#define COMMON_COLLECTION_PREFIX_MAP_H
...
private:
    ...
    {
        return common::MD5::Digest64(str.data(), str.size());
    }
...
#endif // COMMON_COLLECTION_PREFIX_MAP_H
