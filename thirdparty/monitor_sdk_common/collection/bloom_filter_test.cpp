...
#include "thirdparty/monitor_sdk_common/collection/bloom_filter.h"
...
TEST(BloomFilter, Performace)
{
    ...
    printf(
        ...
        static_cast<unsigned long long>(bloom_filter.MemorySize()),
        bloom_filter.HashNumber()
    );
    ...
    uint64_t end_time = GetTimeStampInMs();
