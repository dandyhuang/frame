...
static void CreateNode(const FieldDescriptor* field,
    ...
    case FieldDescriptor::CPPTYPE_INT64:
        (*node)[field->name()] = common::IntegerToString(reflection->GetInt64(message, field));
        break;
    case FieldDescriptor::CPPTYPE_UINT32:
        (*node)[field->name()] = reflection->GetUInt32(message, field);
        break;
    case FieldDescriptor::CPPTYPE_UINT64:
        (*node)[field->name()] = common::IntegerToString(reflection->GetUInt64(message, field));
        break;
...
static void CreateNodeOfRepeatedField(const FieldDescriptor* field,
    ...
    case FieldDescriptor::CPPTYPE_INT32:
        ...
        break;
    case FieldDescriptor::CPPTYPE_INT64:
        node->append(common::IntegerToString(
...
static bool SetSingleValueForMessage(const Reflection* reflection,
    ...
    case FieldDescriptor::CPPTYPE_INT64: {
        int64_t number = 0;
        if (!common::StringToNumber(node.asString(), &number)) {
...
static bool SetRepeatedValueForMessage(const Reflection* reflection,
    ...
    case FieldDescriptor::CPPTYPE_INT64: {
        int64_t number = 0;
        if (!common::StringToNumber(sub_node.asString(), &number)) {
