...
#include "thirdparty/monitor_sdk_common/encoding/percent.h"
#include "thirdparty/monitor_sdk_common/base/array_size.h"
#include "thirdparty/monitor_sdk_common/base/string/algorithm.h"
#include "thirdparty/monitor_sdk_common/encoding/percent_test_gbk.cpp"
#include "thirdparty/monitor_sdk_common/encoding/percent_test_utf8.cpp"
...
{
    std::string encoded(kTigerUtf8Encoded, COMMON_ARRAY_SIZE(kTigerUtf8Encoded) - 2);
    std::string decoded;
