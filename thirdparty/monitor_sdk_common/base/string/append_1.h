...
#ifndef COMMON_BASE_STRING_APPEND_1_H
#define COMMON_BASE_STRING_APPEND_1_H
#pragma once
...
void StringAppend(std::string* str, const T& value)
{
    ...
    // disable them
    COMMON_STATIC_ASSERT((!std::is_same<T, signed char>::value),
        "signed char is not allowed");
    COMMON_STATIC_ASSERT((!std::is_same<T, unsigned char>::value),
...
#endif // COMMON_BASE_STRING_APPEND_1_H
