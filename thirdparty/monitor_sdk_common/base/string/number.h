...
#ifndef COMMON_BASE_STRING_NUMBER_H
#define COMMON_BASE_STRING_NUMBER_H
...
{
    COMMON_STATIC_ASSERT(std::is_integral<Type>::value, "Type must be integral type");
    char* endptr;
...
#endif // COMMON_BASE_STRING_NUMBER_H
