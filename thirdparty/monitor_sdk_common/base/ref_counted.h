...
#ifndef COMMON_BASE_REF_COUNTED_H
#define COMMON_BASE_REF_COUNTED_H
#pragma once
...
private:
    ...
    COMMON_DECLARE_UNCOPYABLE(IRefCounted);
};
...
private:
    ...
    COMMON_DECLARE_UNCOPYABLE(RefCountedBase);
};
...
#endif // COMMON_BASE_REF_COUNTED_H
