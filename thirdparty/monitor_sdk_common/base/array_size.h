// Copyright (c) 2011, The COMMON Authors.
// All rights reserved.
//
// Author: CHEN Feng <chen3feng@gmail.com>
// Created: Dec 24, 2010

#ifndef COMMON_BASE_ARRAY_SIZE_H
#define COMMON_BASE_ARRAY_SIZE_H
...
#define COMMON_ARRAY_SIZE(a) sizeof(::common::ArraySizeHelper::Helper(a))
...
#define COMMON_ARRAY_SIZE(a) \
    ((sizeof(a) / sizeof(*(a))) / (size_t)(!(sizeof(a) % sizeof(*(a)))))

#endif // __cplusplus

#endif // COMMON_BASE_ARRAY_SIZE_H
