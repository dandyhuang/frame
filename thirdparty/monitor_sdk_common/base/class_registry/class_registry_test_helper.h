...
#ifndef COMMON_BASE_CLASS_REGISTRY_CLASS_REGISTRY_TEST_HELPER_H
#define COMMON_BASE_CLASS_REGISTRY_CLASS_REGISTRY_TEST_HELPER_H
...
COMMON_CLASS_REGISTRY_DEFINE(second_mapper_registry, Mapper);
...
#define CREATE_SECONDARY_MAPPER(mapper_name_as_string) \
    COMMON_CLASS_REGISTRY_CREATE_OBJECT(second_mapper_registry, \
...
COMMON_CLASS_REGISTRY_DEFINE(reducer_registry, Reducer);
...
#define CREATE_REDUCER(reducer_name_as_string) \
    COMMON_CLASS_REGISTRY_CREATE_OBJECT(reducer_registry, reducer_name_as_string)
...
#endif  // COMMON_BASE_CLASS_REGISTRY_CLASS_REGISTRY_TEST_HELPER_H
