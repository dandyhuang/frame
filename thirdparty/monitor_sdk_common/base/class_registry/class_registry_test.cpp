...
#include "thirdparty/monitor_sdk_common/base/class_registry/class_registry_test_helper.h"
...
COMMON_CLASS_REGISTRY_DEFINE(some_class_registry, SomeClass);
...
#define CREATE_SOME_CLASS(name_as_string) \
    COMMON_CLASS_REGISTRY_CREATE_OBJECT(base_namespace::some_class_registry, name_as_string)
