...
#include "thirdparty/monitor_sdk_common/base/compatible/stdbool.h"
 ...
 * @return the total length of the string tried to create
 */
COMPATIBLE_INLINE size_t strlcat(char *dest, const char *src, size_t count)
{
...
/// @sa strpbrk
COMPATIBLE_INLINE const char* strnpbrk(const char* str, size_t length, const char* chars)
{
