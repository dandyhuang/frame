...
//
//  @date:      2013-05-14 13:41
//  @file:      param_annotation.h
//  @author:    
//  @brief:     
//
//********************************************************************
...
#ifndef COMMON_BASE_FUNCTION_PARAM_ANNOTATION_H
#define COMMON_BASE_FUNCTION_PARAM_ANNOTATION_H
#pragma once
...
template <typename T>
struct MaybeRefCount<TypeTraits::FalseType, T>
{
...
struct MaybeRefCount<TypeTraits::FalseType, T[n]>
{
    static void AddRef(const T*) {}
    static void Release(const T*) {}
};
...
template <typename T>
struct MaybeRefCount<TypeTraits::TrueType, T>
{
...
template <typename T>
struct MaybeRefCount<TypeTraits::TrueType, UnretainedWrapper<T> >
{
...
template <typename T>
struct MaybeRefCount<TypeTraits::TrueType, const T*>
{
...
#endif // COMMON_BASE_FUNCTION_PARAM_ANNOTATION_H
