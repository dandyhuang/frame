...
#ifndef COMMON_NET_URI_URI_H
#define COMMON_NET_URI_URI_H
...
template <>
inline void swap(common::UriAuthority& x, common::UriAuthority& y)
{
    x.Swap(&y);
}

template <>
inline void swap(common::URI& x, common::URI& y)
{
    x.Swap(&y);
}
