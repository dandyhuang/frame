...
#ifndef COMMON_NET_HTTP_HEADERS_H
#define COMMON_NET_HTTP_HEADERS_H
#pragma once
...
namespace std {
template <>
inline void swap(common::HttpHeaders& lhs, common::HttpHeaders& rhs) {
    lhs.Swap(&rhs);
}
} // namespace std

#endif // COMMON_NET_HTTP_HEADERS_H
