...
#ifndef COMMON_NET_HTTP_REQUEST_H
#define COMMON_NET_HTTP_REQUEST_H
#pragma once
...
template <>
inline void swap(common::HttpRequest& lhs, common::HttpRequest& rhs) {
    lhs.Swap(&rhs);
}

} // namespace std

#endif // COMMON_NET_HTTP_REQUEST_H
