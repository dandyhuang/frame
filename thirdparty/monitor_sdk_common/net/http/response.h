...
#ifndef COMMON_NET_HTTP_RESPONSE_H
#define COMMON_NET_HTTP_RESPONSE_H
#pragma once
...
template <>
inline void swap(common::HttpResponse& lhs, common::HttpResponse& rhs) {
    lhs.Swap(&rhs);
}

} // namespace std

#endif // COMMON_NET_HTTP_RESPONSE_H
