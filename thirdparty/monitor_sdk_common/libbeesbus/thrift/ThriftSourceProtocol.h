...
class ThriftSourceProtocolIfSingletonFactory : virtual public ThriftSourceProtocolIfFactory {
 public:
  ThriftSourceProtocolIfSingletonFactory(const ::std::shared_ptr<ThriftSourceProtocolIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::std::shared_ptr<ThriftSourceProtocolIf> iface_;
};
...
class ThriftSourceProtocol_append_args {
 public:
  ...
  virtual ~ThriftSourceProtocol_append_args() noexcept;
...
class ThriftSourceProtocol_append_pargs {
 public:
  ...
  virtual ~ThriftSourceProtocol_append_pargs() noexcept;
...
class ThriftSourceProtocol_append_result {
 public:
  ...
  virtual ~ThriftSourceProtocol_append_result() noexcept;
  Status::type success;
...
class ThriftSourceProtocol_append_presult {
 public:
  ...
  virtual ~ThriftSourceProtocol_append_presult() noexcept;
  Status::type* success;
...
class ThriftSourceProtocol_appendBatch_args {
 public:
  ...
  virtual ~ThriftSourceProtocol_appendBatch_args() noexcept;
...
class ThriftSourceProtocol_appendBatch_pargs {
 public:
  ...
  virtual ~ThriftSourceProtocol_appendBatch_pargs() noexcept;
...
class ThriftSourceProtocol_appendBatch_result {
 public:
  ...
  virtual ~ThriftSourceProtocol_appendBatch_result() noexcept;
  Status::type success;
...
class ThriftSourceProtocol_appendBatch_presult {
 public:
  ...
  virtual ~ThriftSourceProtocol_appendBatch_presult() noexcept;
  Status::type* success;
...
class ThriftSourceProtocolClient : virtual public ThriftSourceProtocolIf {
 public:
  ThriftSourceProtocolClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  ThriftSourceProtocolClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class ThriftSourceProtocolProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  ThriftSourceProtocolProcessor(::std::shared_ptr<ThriftSourceProtocolIf> iface) :
    iface_(iface) {
...
class ThriftSourceProtocolProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  ThriftSourceProtocolProcessorFactory(const ::std::shared_ptr< ThriftSourceProtocolIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::std::shared_ptr< ThriftSourceProtocolIfFactory > handlerFactory_;
};

class ThriftSourceProtocolMultiface : virtual public ThriftSourceProtocolIf {
 public:
  ThriftSourceProtocolMultiface(std::vector<std::shared_ptr<ThriftSourceProtocolIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~ThriftSourceProtocolMultiface() {}
 protected:
  std::vector<std::shared_ptr<ThriftSourceProtocolIf> > ifaces_;
  ThriftSourceProtocolMultiface() {}
  void add(::std::shared_ptr<ThriftSourceProtocolIf> iface) {
...
class ThriftSourceProtocolConcurrentClient : virtual public ThriftSourceProtocolIf {
 public:
  ThriftSourceProtocolConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  ThriftSourceProtocolConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
