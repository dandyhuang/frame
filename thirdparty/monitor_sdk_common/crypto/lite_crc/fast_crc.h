...
/**
 * @file fast_crc.h
 * @brief fast_crc冲突率偏高, 计算速度快, 请有选择性的使用
 * @author chenzheng05@baidu.com
 * @date 2015-01-21
 */
#ifndef COMMON_CRYPTO_LITE_CRC_FAST_CRC_H
#define COMMON_CRYPTO_LITE_CRC_FAST_CRC_H
...
#endif // COMMON_CRYPTO_LITE_CRC_FAST_CRC_H
